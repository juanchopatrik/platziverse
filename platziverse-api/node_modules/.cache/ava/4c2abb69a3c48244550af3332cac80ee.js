...
test.serial.cb('/api/agent/:uuid', t => {
  request(server).get(`/api/agents/${uuid}`).expect(200).expect('Content-Type', /json/).end((err, res) => {
    t.falsy(err, 'should not return an error');
    let body = JSON.stringify(res.body);
...
//# sourceMappingURL=/home/juancho/Documentos/platzi/platziverse/platziverse-api/node_modules/.cache/ava/4c2abb69a3c48244550af3332cac80ee.js.map