...
test.serial.cb('/api/agents/:uuid', t => {
  request(server).get(`/api/agents/${uuidArgs}`).expect.deepEqual(body, agentFixtures.byUuid(uuid), 'agent should be the same').expect('Content-Type', /json/).end((err, res) => {
    t.falsy(err, 'should not return an error');
    let body = JSON.stringify(res.body);
...
//# sourceMappingURL=/home/juancho/Documentos/platzi/platziverse/platziverse-api/node_modules/.cache/ava/9ee97963768d66ce073d3c710da62ff5.js.map