...
test.serial.cb('/api/agents/:uuid', t => {
  request(server).get(`/api/agents/${uuidArgs}`).expect.deepEqual(agent, agentFixtures.byUuid(uuid), 'agent should be the same').expect('Content-Type', /json/).end((err, res) => {
    t.falsy(err, 'should not return an error');
    let body = JSON.stringify(res.body);
...
//# sourceMappingURL=/home/juancho/Documentos/platzi/platziverse/platziverse-api/node_modules/.cache/ava/3bc7c6ece0ab2629c92e3a40edd67842.js.map