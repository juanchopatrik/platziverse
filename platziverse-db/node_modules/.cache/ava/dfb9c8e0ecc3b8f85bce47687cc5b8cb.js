...
test.beforeEach(async () => {
  ...
  AgentStub.findById.withArgs(id).returns(Promise.resolve(agentFixtures.byId(id))); // Model findOne Stub

  AgentStub.findOne = sandbox.stub();
  AgentStub.findOne.withArgs(uuidArgs).returns(Promise.resolve(agentFixtures.byUuid(uuid))); //model findAll Stub
...
//# sourceMappingURL=/home/juancho/Documentos/platzi/platziverse/platziVerse-db/node_modules/.cache/ava/dfb9c8e0ecc3b8f85bce47687cc5b8cb.js.map